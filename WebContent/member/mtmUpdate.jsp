...
<body>
<form name="frm" method="post" action="ShopServlet?command=mtmUpdate&mNum=${mtm.mNum}">
<input type="hidden" name="mNum" value="${mtm.mNum}">
	<div id="big">
		<div id="small">
			<div id="header">
			...
			<div id="a_container">
				...
				<br>
				<div id="div_but">
					<input type="submit" value="수정하기" id="but" class="submit"> 
